    ...
    <div className="job">
        ...
        <div className="summary">
          ...
          <div className="apply--buttons">
            <button
              ...
              onClick={() => props.handleApplyDetails(props.item.id)}
            >
              Apply
            </button>
            <button
              className="btn btn-info"
              onClick={() => props.handleJobDetails(props.item.id)}
            >
              {props.item.details ? "Less details" : "More Details"}
            </button>
          </div>
        </div>
      </div>
      {props.item.details && (
        <div>
          ...
          <h2>
            Salary:{props.item.Salary} {props.item.Currency}
          </h2>
        </div>
      )}
    </div>
